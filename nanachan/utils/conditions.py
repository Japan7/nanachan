...
class StringCondition(Condition):
    ...
    words = [
        ...
        Word(
            r'hk|hollow knight|silksong',
            'talks about a game which finally got its sequel released.',
            'talked about a game which finally got its sequel released.',
        ),
        Word(r'uma(musume)?', 'is farming 🥕', 'was farming 🥕'),
        Word.simple('bruh'),
        Word.singular('vegan'),
        Word.simple('japon'),
